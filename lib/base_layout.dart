...
class _MainScreenState extends State<MainScreen> {
  ...
  late StreamSubscription<void> playlistSubscription;
  late StreamSubscription<void> playlistSongSubscription;
  ...
  void setupPlaylistStream() async {
    ...
    playlistSongSubscription = playlistSongStream.listen((_) {
      fetchPlaylist();
    });
  }
  ...
  void dispose() {
    ...
    playlistSongSubscription.cancel();
    super.dispose();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: !isLoading
          ? MyAppbar(
              selectedPlaylist: playlists.isEmpty
                  ? selectedPlaylist
                  : selectedPlaylist ??
                      playlists[selectedPlaylistIndex >= playlists.length
                          ? 0
          ...
          : playlists.isEmpty
              ...
              : YaruMasterDetailPage(
                  ...
                  pageBuilder: (context, index) {
                    if (playlists[index].type ==
                        playlist_model.PlaylistType.main) {
